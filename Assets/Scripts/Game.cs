...
public class Game : MonoBehaviour
{
    ...
    public void Win()
    {
        ...
        if (coins == totalCoins)
        {
            ...
            {
                text.Add(successText[i].Replace("xxx", coins.ToString()).Replace("yyy", totalCoins.ToString()).Replace("ttt", totalTime.ToString("F1")));
            }
        ...
        } else
        {
            ...
            {
                text.Add(failureText[i].Replace("xxx", coins.ToString()).Replace("yyy", totalCoins.ToString()).Replace("ttt", totalTime.ToString("F1")));
            }
            textManager.ShowText(text, () => { });
        }
        NewLevel();
